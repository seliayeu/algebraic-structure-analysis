func.func @kernel() -> f32{
    ...
    %e1 = tensor.empty(%c0) : tensor<1024x1024xf32>
    %e2 = tensor.empty(%c0) : tensor<1024x1024xf32>
    %e3 = tensor.empty(%c0) : tensor<1024x1024xf32>
    ...
    %R2 = dia.matmul ins(%R1, %At: tensor<1024x1024xf32>, tensor<1024x1024xf32>)
                        outs(%e2 : tensor<1024x1024xf32>) -> tensor<1024x1024xf32>
    %P1 = dia.elementwise kind = <add> ins(%R2, %Q: tensor<1024x1024xf32>, tensor<1024x1024xf32>) 
