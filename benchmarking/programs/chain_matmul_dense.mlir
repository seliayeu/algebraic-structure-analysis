func.func @kernel() -> f32{
    ...
    %R1 = linalg.matmul ins(%I0, %I1 : tensor<1024x1024xf32>, tensor<1024x1024xf32>)
                        outs(%e0 : tensor<1024x1024xf32>) -> tensor<1024x1024xf32>
    %R2 = linalg.matmul ins(%R1, %I2: tensor<1024x1024xf32>, tensor<1024x1024xf32>)
                        outs(%e1 : tensor<1024x1024xf32>) -> tensor<1024x1024xf32>
    %R3 = linalg.matmul ins(%R2, %I3: tensor<1024x1024xf32>, tensor<1024x1024xf32>)
                        outs(%e2 : tensor<1024x1024xf32>) -> tensor<1024x1024xf32>

    %index = arith.constant 5: index
    %result = tensor.extract %R3[%index, %index] : tensor<1024x1024xf32>
    return %result : f32
}
