func.func @kernel() -> f32{
    ...
    %dense = arith.constant {metadata = {upperBw = 0 : i64, lowerBw = 0 : i64, propertyDims = [0, 1]}}
        dense<[[1.0, 1.0, 1.0], [1.0, 2.0, 1.0], [1.0, 1.0, 3.0]]> : tensor<3x3xf32>
    ...
    %e0 = arith.constant dense<1.0>: tensor<1024x1024xf32>
    %e1 = arith.constant dense<1.0>: tensor<1024x1024xf32>
    %e2 = arith.constant dense<1.0>: tensor<1024x1024xf32>
    %e3 = arith.constant dense<1.0>: tensor<1024x1024xf32>
